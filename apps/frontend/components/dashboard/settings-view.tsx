...
import {
    User, Lock, Bell, Users, Save, Shield
} from "lucide-react";
                            ...
                            <div className="border-t pt-6">
                                ...
                                <div className="flex items-center justify-between p-3 border rounded-md bg-muted/50">
                                    <div className="space-y-1">
                                        ...
                                        <div className="text-xs text-muted-foreground">Created 2 months ago</div>
                                    </div>
                                    <Button variant="ghost" size="sm"><Lock className="h-4 w-4" /></Button>
                                </div>
                                <Button variant="outline" className="mt-4 w-full">Generate New Key</Button>
                            </div>
                        </CardContent>
                    </Card>
                </TabsContent>
                ...
                <TabsContent value="notifications">
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            {[
                                { title: "Deployment Status", desc: "Get notified when a deployment succeeds or fails." },
                                { title: "Budget Alerts", desc: "Receive alerts when you reach 80% of your budget." },
                                { title: "Security Alerts", desc: "Important security notifications about your account." },
                                ...
                                <div key={i} className="flex items-center justify-between p-2">
                                    ...
                                    <div className="flex items-center h-6">
                                        <Switch defaultChecked={i < 3} className="data-[state=checked]:bg-orange-600" />
                                    </div>
                                </div>
                            ))}
                        </CardContent>
                        <CardFooter className="border-t px-6 py-4">
                            <Button className="bg-orange-600 hover:bg-orange-700 text-white">Save Preferences</Button>
                        </CardFooter>
                    </Card>
                </TabsContent>
