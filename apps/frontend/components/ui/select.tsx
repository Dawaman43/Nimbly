...
// Note: A full accessible Select is complex. This is a visual-only implementation for the demo.
...
>(({ className, children, ...props }, ref) => {
    ...
    return (
        <div
            ref={ref}
            className={cn(
                "absolute top-[calc(100%+4px)] z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popover text-popover-foreground shadow-md animate-in fade-in-80",
                className
            )}
            {...props}
        >
